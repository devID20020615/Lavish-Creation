...
export const InquiryModal: React.FC<InquiryModalProps> = ({
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 bg-[#242424]/80 backdrop-blur-md flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
        <motion.div
          initial={{ opacity: 0, scale: 0.95, y: 15 }}
          animate={{ opacity: 1, scale: 1, y: 0 }}
          exit={{ opacity: 0, scale: 0.95, y: 15 }}
          transition={{ duration: 0.3, ease: "easeOut" }}
          className="bg-[#FAF8F5] rounded-2xl sm:rounded-3xl max-w-2xl w-full border-2 border-[#D8C2A3] shadow-2xl relative overflow-hidden my-auto max-h-[92vh] flex flex-col"
        >
