      ...
      <div className="py-8 px-3 sm:px-6 max-w-xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-sm text-[#7A6A5C] mb-6 leading-relaxed">
            Client Management & Financial CRM requires email verification for authorized personnel.
          </p>
          ...
          >
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-2xl border border-stone-300 text-sm text-stone-900 bg-white placeholder:text-stone-400 focus:outline-hidden focus:border-[#8C1D18] focus:ring-2 focus:ring-[#8C1D18]/20 transition-all font-mono"
              />
            </div>
            ...
            <button
              ...
              className="w-full py-3.5 px-6 rounded-2xl bg-[#8C1D18] hover:bg-[#6e1612] text-white font-bold text-sm shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
            >
              {isSigningIn ? (
                <>
