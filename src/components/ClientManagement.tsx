          ...
          {isGoogleModalOpen && (
            <div className="fixed inset-0 z-[120] bg-black/70 backdrop-blur-xs flex items-center justify-center p-4">
              ...
              >
                ...
                <div className="mb-6">
                  <h4 className="text-xl font-bold text-stone-900 mb-1">Sign in with your Google Account</h4>
                  <p className="text-xs text-stone-500">Enter your authorized Gmail address to continue to <span className="font-semibold text-[#8C1D18]">Client Management</span>.</p>
                </div>

                {/* Google Account Email Form */}
                <form
                  onSubmit={(e) => {
                    e.preventDefault();
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-2xl border border-stone-300 text-sm text-stone-900 placeholder:text-stone-400 focus:outline-hidden focus:border-[#8C1D18] focus:ring-2 focus:ring-[#8C1D18]/20 transition-all font-mono"
                    />
                  </div>
