...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/80 backdrop-blur-md overflow-hidden overscroll-contain"
      onWheel={(e) => {
    ...
    >
      <motion.div
        ...
        className="bg-[#FAF8F5] w-full max-w-6xl h-[95vh] sm:h-[92vh] max-h-[95vh] sm:max-h-[92vh] rounded-2xl sm:rounded-3xl shadow-2xl flex flex-col border-2 border-[#D4B16A]/60 overflow-hidden relative min-w-0 overscroll-contain"
      >
        {/* Top Accent */}
        <div className="gamosa-border" />

        {/* Header Bar */}
        <div className="bg-[#242424] text-[#FAF8F5] px-3.5 sm:px-6 py-3 sm:py-4 flex items-center justify-between gap-2 border-b border-[#D4B16A]/30 shrink-0 min-w-0">
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden p-3 sm:p-6 bg-[#FAF8F5] min-w-0">
          ...
          {activeTab === 'videos' && (
            <div className="space-y-4 sm:space-y-6 min-w-0">
              ...
              {isAddingVideo && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-2.5 sm:p-4 bg-black/60 backdrop-blur-xs overflow-hidden">
                  <motion.div
                    initial={{ opacity: 0, scale: 0.95 }}
                    animate={{ opacity: 1, scale: 1 }}
                    exit={{ opacity: 0, scale: 0.95 }}
                    className="bg-[#FAF8F5] border-2 border-[#D8C2A3] rounded-2xl max-w-lg w-full overflow-hidden shadow-2xl flex flex-col max-h-[90vh] min-w-0"
                  >
        ...
        <AnimatePresence>
          {isAddingNew && (
            <div className="fixed inset-0 z-[100] bg-black/80 backdrop-blur-xs flex items-center justify-center p-2.5 sm:p-6 overflow-hidden">
              <motion.div
                initial={{ opacity: 0, scale: 0.92 }}
                animate={{ opacity: 1, scale: 1 }}
                exit={{ opacity: 0, scale: 0.92 }}
                className="bg-[#FAF8F5] border-2 border-[#D4B16A] rounded-2xl sm:rounded-3xl max-w-xl w-full max-h-[90vh] overflow-hidden shadow-2xl relative my-auto flex flex-col box-border min-w-0"
              >
                <button
                  type="button"
          ...
          {isBulkImporterOpen && (
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-2.5 sm:p-4 bg-black/60 backdrop-blur-xs overflow-hidden">
              <motion.div
                ...
                className="bg-[#FAF8F5] border-2 border-[#D4B16A] rounded-2xl max-w-2xl w-full overflow-hidden shadow-2xl flex flex-col max-h-[90vh] min-w-0"
              >
                {/* Header */}
