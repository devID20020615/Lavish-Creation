...
export const AdminLoginModal: React.FC<AdminLoginModalProps> = ({
  ...
  return (
    <AnimatePresence>
      <div
        className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-md overscroll-contain overflow-hidden"
      ...
      >
        <motion.div
          ...
          className="bg-[#FAF8F5] border-2 border-[#D4B16A]/60 rounded-3xl p-6 sm:p-8 max-w-md w-full shadow-2xl relative overflow-hidden overscroll-contain"
        >
